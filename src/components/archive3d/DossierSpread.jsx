...
export default function DossierSpread({
  activeTab,
  setActiveTab,
  onCloseDossier,
  onOpenReadingView
  ...
  const tabs = [
    { id: 'subject', number: '01', label: 'The subject', pages: '01 - 02' },
    { id: 'service', number: '02', label: 'Service record', pages: '03 - 04' },
    { id: 'internhunter', number: '03', label: 'InternHunter AI', pages: '05 - 06' },
    { id: 'agrismart', number: '04', label: 'AgriSmart', pages: '07 - 08' },
    { id: 'mlops', number: '05', label: 'End-to-End MLOps', pages: '09 - 10' },
    { id: 'certifications', number: '06', label: 'Certifications', pages: '11 - 12' },
    { id: 'contact', number: '07', label: 'Open a channel', pages: '13 - 14' }
  ]

  const currentTabIndex = tabs.findIndex(t => t.id === activeTab)
  const activeTabInfo = tabs[currentTabIndex] || tabs[0]
  ...
  return (
    <div className="dossier-overlay-container">
      {/* 2-Page Open Folder Desk Spread */}
      <div className="dossier-book-wrapper">
        {/* Right side navigation tabs */}
        <aside className="dossier-side-tabs" aria-label="Dossier Chapters">
          {tabs.map((tab) => (
            <button
              key={tab.id}
            ...
            >
              <span className="tab-idx">{tab.number}</span>
        ...
        {/* The Two Pages */}
        <div className="dossier-pages-spread">
          ...
          {/* ================= SPREAD 7: OPEN A CHANNEL (CONTACT) ================= */}
          {activeTab === 'contact' && (
            <>
              {/* Left Page (13) */}
              <div className="dossier-page left-page">
              ...
              <div className="dossier-page right-page">
                ...
                <h2 className="subject-editorial-title">
                  Send a <span className="serif-italic">dispatch.</span>
                </h2>

                {formSent ? (
                  <div className="dispatch-success-box">
                    <div className="success-badge">TRANSMISSION RECEIVED</div>
                    <h3 className="success-heading">Signal logged in archive.</h3>
                    <p className="success-msg">
                      Thank you for reaching out. I have received your message dispatch and will respond promptly to your coordinates.
                    </p>
                    <button
                  ...
                  <form className="dispatch-form" onSubmit={handleFormSubmit}>
                    <div className="form-group-archive">
                      <label>SENDER IDENTITY / NAME</label>
                      <input
                        type="text"
                        required
                    ...
                    <div className="form-group-archive">
                      ...
                      <input
                        type="email"
                        required
                        placeholder="e.g. marie@research-lab.org"
                    ...
                    <div className="form-group-archive">
                      ...
                      <textarea
                        required
                        rows="4"
                        placeholder="Discussing an autonomous agent project, PFE opportunity, or MLOps architecture..."
      ...
      {/* Dossier Bottom Bar Navigation */}
      <div className="dossier-bottom-bar">
        <button
          className="dossier-return-btn"
          onClick={() => {
        ...
        <div className="dossier-page-flipper">
          <button
            className="flip-btn"
            onClick={goToPrev}
        ...
        <button
          className="dossier-reading-mode-btn"
          onClick={() => {
            soundManager.playSoftClick()
            onOpenReadingView()
          }}
